                            ...
                            <div class="row">
                                <div class="col-md-6 text-center align-self-center">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                        ...
                                        <input type="radio" class="btn-check" name="D0129CB6" id="DE92759F" autocomplete="off" value="off" v-model="messageStore.offOnSwitch">
                                        <label class="btn btn-secondary" for="DE92759F">
                                            Turn off devices
                                        </label>

                                        <input type="radio" class="btn-check" name="D0129CB6" id="D8FB7C2E" autocomplete="off" value="on" v-model="messageStore.offOnSwitch">
                                ...
                                <div class="col-md-6 text-center align-self-center">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="250" height="250" :fill="messageStore.offOnSwitch === 'on' ? '#0d6efd' : '#6c757d'" viewBox="0 0 16 16">
